...
/* ===========================================
   ...
   =========================================*/
	...
	$('.menuSelect select').live('change', function () {
		$this = $(this);
		$id = $(this).val();
...
/* ===========================================
   ...
   =========================================*/
	...
	$('.productStar').live('click', function (e) {
		e.preventDefault();
		...
		$.ajax({
			url: '/ajax/admin/admin_functionality.php',
			type: 'POST',
			data: {'productTitle': _title, 'id': _id},
			success: function (data) {
				if (_title == 'featured') {
					_parent.html(data);
				} else {
					redirectTo('forms/products/list_product.php');
				}
			}
		});
	});
