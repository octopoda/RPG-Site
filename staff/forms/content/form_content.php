...
<div class="header">
	<form id="formUpdate" method="POST">
		<fieldset>
            ...
            <p>
                <label for="script_embed">SRC for embeded Script</label>
                <input type="text" name="script_embed" id="script_embed">
            </p>

            <p>If embedding a script tag into the content please add the src attribute to the correct input box and place {! content:<span class="embed_title"></span> !} where you would like to have the entire script tag posted.</p>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.embed_title').html($('#title').val());

        $('#title').live('change', function (e) {
            $('.embed_title').html($(this).val());
        });
    });
