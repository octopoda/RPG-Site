<?php
	...
	else if ($users->access < 4) redirect('/no_access.html');
...
<section id="siteWrapper">
    ...
    <section id="main" class="clearfix row">
        ...
        <aside id="sidebar">
            ...
            <p>Maybe you need some help styling.  <a target="_blank" href="/style_guide.html">Look through your component style guide.</a> </p>
            <p>Or how about styling text. <a target="_blank" href="/style_guide2.html">Looks through your text style guide.</a></p>
